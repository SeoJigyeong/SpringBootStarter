		  ...
		  <div class="login-form">
		   <form action="adm_loginck.jsp" method="post">
		       ...
		       <div class="form-group">
		           <input type="text" class="form-control" name="id" placeholder="아이디" value="" required="required">
		       </div>
		       <div class="form-group">
		           <input type="text" class="form-control" name="pwd" placeholder="비밀번호" value="" required="required">
		       </div>
		       <div class="form-group">
