      ...
      <div class="container-fluid">
		<header>
			...
			%>
				...
				<a href="#" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" style="pointer-events: none; text-decoration: line-through;" title="vipRoom">vipRoom - 예약 불가능</a>
			...
			%>
				<a href="d_ResrvForm_02.jsp?month=<%=month%>&date=<%=date%>&room=Vip Room" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" title="vipRoom">vipRoom - 예약 불가능</a>
      			<a href="#" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" style="pointer-events: none; text-decoration: line-through;" title="doubleRoom">doubleRoom - 예약 불가능</a>
      			<a href="d_ResrvForm_02.jsp?month=<%=month%>&date=<%=date%>&room=Single Room" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" title="singleRoom">singleRoom - 예약 가능</a>
			</div>
			<% 					
							eventCheck++;
			...
			%>
				<a href="d_ResrvForm_02.jsp?month=<%=month%>&date=<%=date%>&room=Vip Room" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" title="vipRoom">vipRoom - 예약 불가능</a>
      			<a href="d_ResrvForm_02.jsp?month=<%=month%>&date=<%=date%>&room=Double Room" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white" style="pointer-events: none; text-decoration: line-through;" title="doubleRoom">doubleRoom - 예약 가능</a>
      			<a href="#" class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-secondary text-white disabled" title="singleRoom">singleRoom - 예약 블가능</a>
			</div>
			<% 
							eventCheck++;
							} else {
