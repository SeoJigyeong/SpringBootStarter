      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">홈</a></span> <span>예약 상황</span></p>
      ...
      <div class="container resv-container">
		...
		<div class="col-md-6 resv-form-1" style="background-image: url('images/seogniel_adm3_2.jpg');"></div>
			<div class="col-md-6 resv-form-1">
				<h3>예약 하기</h3>
				<form method="post" action="d_writeResrv_03.jsp" accept-charset="utf-8">
			...
			<!-- 			<input type="password" class="form-control"
							placeholder="Reserve Date" value="" /> -->
					</div>
					<div class="form-group">
						<label for="exampleFormControlSelect1">룸</label> 
					...
					<div class="form-group">
						<input type="text" class="form-control" id="phone" name="phone"
							placeholder="연락처" value="" />
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="accountName" name="accountName"
 							placeholder="예금자명" value="" />
					</div>
					<div class="form-group">
